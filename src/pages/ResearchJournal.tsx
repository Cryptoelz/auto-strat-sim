...
const ENTRIES: Entry[] = [
  { date: '2026-06-19', type: 'created',      title: 'Volatility Compression Breakout v1 (VCB v1) seeded',     body: 'Volatility Compression Breakout v1 seeded as Strategy #5 candidate to complete the five-strategy ecosystem. Strategy designed to identify explosive volatility expansions following extended compression periods. 15m timeframe, ATR(14)<70% of 30d avg + BB Width in lowest 20% of 50 candles for compression; 20-candle range break with 1.5x volume and ATR expansion for trigger; 1 ATR stop, 3R target, trail after 1.5R. Runs in isolated research sandbox — not connected to Portfolio Manager or allocation engine, cannot affect Router v2 testing. Status: Research Only, Promotion Disabled.', impact: 'Medium', author: 'Operator', refs: ['VCB v1'] },
