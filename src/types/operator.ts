...
export const DEFAULT_POLICIES: PolicyRule[] = [
  ...
  { id: 'pol_eth', type: 'asset_enabled', enabled: true, label: 'ETHUSDT Enabled', description: 'Allow trading ETHUSDT', params: { asset: 'ETHUSDT' } },
  { id: 'pol_sol', type: 'asset_enabled', enabled: true, label: 'SOLUSDT Enabled', description: 'Allow trading SOLUSDT', params: { asset: 'SOLUSDT' } },
...
export const POLICY_TEMPLATES: PolicyTemplate[] = [
  ...
  },
  {
    ...
    policies: [
      ...
      { id: 'pol_eth', type: 'asset_enabled', enabled: false, label: 'ETHUSDT Disabled', description: 'Disable ETHUSDT', params: { asset: 'ETHUSDT' } },
      { id: 'pol_sol', type: 'asset_enabled', enabled: false, label: 'SOLUSDT Disabled', description: 'Disable SOLUSDT', params: { asset: 'SOLUSDT' } },
    ],
    overrides: {},
  },
  {
