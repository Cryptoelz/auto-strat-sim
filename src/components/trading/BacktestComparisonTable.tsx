...
export function BacktestComparisonTable() {
  const runs = useMemo(() => {
    ...
    const names = ['Baseline v9', 'Baseline v8', 'Baseline v7', 'Baseline v6', 'Baseline v5', 'Baseline v4', 'Baseline v3', 'Baseline v2', 'Baseline v1', 'Candidate 2', 'Candidate 3', 'Candidate 4', 'Candidate 6', 'Candidate 13', 'Mean Reversion', 'Candidate 15', 'Candidate 16', 'Candidate 18', 'Candidate 19', 'Candidate 20', 'Candidate 22', 'Candidate 23'];
    return store.runs
